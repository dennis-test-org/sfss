...
def main():
    ...
    # Upload command
    upload_parser = subparsers.add_parser('upload', help='Upload a file to local storage system')
    ...
    download_parser.add_argument('download_dir', type=str, help='Directory to download the file to')
    ...
    if args.command == 'init':
        ...
        if args.command == 'upload':
            ...
            try:
                ...
                logger.info(f'File downloaded: {args.file_name} to {args.download_dir} by user {username}')
            except Exception as e:
